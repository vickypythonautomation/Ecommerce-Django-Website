...
SECRET_KEY = 'django-insecure-gs*%qz4^*%iajfcj&fw+fvi9g2z@3w-csf)ym*-76nk^x#(kr2'
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware', # Add this for better static file handling in production
